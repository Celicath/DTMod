...
public class CrossStepPower extends AbstractPower implements SwitchPower {
	public static final String RAW_ID = "CrossStepPower";
	...
	public CrossStepPower(AbstractCreature owner, int amount) {
		this.name = NAME;
		this.ID = POWER_ID;
		this.owner = owner;
		this.amount = amount;
